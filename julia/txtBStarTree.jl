function criaArquivoBStarTree()

    dir = pwd()
    arqDest = open("BStarTree.txt", "w")
    dir_stats = "../estatisticas/BStarTree"
    ...
    for i in qntd
        ...
        for j in ord
            ...
            for k = 1:10
                ...
                sum_time = 0
                sum_comp = 0
                open("$(dir_stats)/bStarTree_$(i)_$(j)_key$(k).txt") do f  
